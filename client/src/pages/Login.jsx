      ...
      <div className="w-full max-w-md">
        <div className="glass-card p-8 sm:p-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-surface-400 mt-1">Sign in to your PayPilot AI account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-xs font-medium text-surface-300 uppercase tracking-wider">
                  Password
                </label>
              </div>
              <div className="relative">
          ...
          <div className="mt-6 pt-6 border-t border-surface-800/80 text-center">
            <button
              ...
              className="text-xs text-primary-400 hover:text-primary-300 underline font-medium mb-4 block mx-auto"
            >
